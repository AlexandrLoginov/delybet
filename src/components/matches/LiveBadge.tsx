...
export function LiveBadge({ minute, className }: LiveBadgeProps) {
  return (
    <span
      className={cn(
        "inline-flex items-center gap-1.5 rounded-md bg-destructive/10 px-1.5 py-0.5 text-[11px] font-semibold uppercase tracking-wider text-destructive ring-1 ring-inset ring-destructive/30",
        className
      )}
    >
      <span
